$(window).scroll(function(event) {
    ...
    stage3_p = (offsetTop-150-$(".block-content").offset().top) /20;
    $(".start_bg_1").stop().animate({backgroundPosition:'100% '+ (200-(offsetTop/10) )+'px' });
    $(".start_bg_2").stop().animate({backgroundPosition:'0% '+ (stage3_p) +'px' });
});
